...
router.post('/', auth, async (req, res) => {
    ...
    try {
        ...
        GoogleCalendarService.syncCreate(req.user._id, appointment._id);
...
router.patch('/:id', auth, async (req, res) => {
    try {
        ...
        if (req.body.status === 'canceled') {
            ...
            GoogleCalendarService.syncDelete(appointment.userId, appointment);
        } else {
            GoogleCalendarService.syncUpdate(appointment.userId, appointment._id);
        }
