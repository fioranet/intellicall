...
const sipTrunkSchema = new mongoose.Schema({
    ...
    // Outbound dial prefix / tech prefix required by some wholesale carriers.
    // Prepended to the destination digits at dial time (the '+' is dropped),
    // e.g. prefix "999" turns +491799988620 into 999491799988620.
    dialPrefix: {
        type: String,
        trim: true,
        default: ''
