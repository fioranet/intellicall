...
async function runCampaign(campaignId, options = {}) {
    ...
    // Key requirements depend on the agent's voice engine: deepgram_agent skips OpenRouter,
    // and sarvam is self-contained (only a Sarvam key). See utils/engine-keys.
